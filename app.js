...
/// when server is startes use this url http://localhost:9000/get-form


//! creating our own express server
//1.npm init -y --> create a package.json file with default values
//2.npm i express  --> "package-lock.json" stores the information like integrity, package-version of dependent modules/packages
//3.npm i express mongodb dotenv -->
//4.  npm i nodemon -g
// 5. nodemon app.js
// check server => url http://localhost:9000/get-form